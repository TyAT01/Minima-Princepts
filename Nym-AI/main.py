...
class NymApp:
    ...
    def user_join(self, username: str) -> str:
        ...
        if last_seen:
            ...
            return f"Nyahaha! A new pawn for my evil schemes! Welcome, {username}. Prepare to witness my magnificence!"
    ...
    def user_leave(self, username: str) -> str:
        ...
        if not self.active_users:
            return f"Hmph. Run away, {username}! I didn't need you anyway! The fortress is MINE!"
        else:
            return f"Good riddance, {username}! One less distraction!"
