...
class LuminaApp:
    ...
    def user_join(self, username: str) -> str:
        ...
        if last_seen:
            ...
            return f"Yay! A new friend! Hi {username}, I'm Lumina! It's so nice to meet you. What's up?"
    ...
    def user_leave(self, username: str) -> str:
        ...
        if not self.active_users:
            return f"Aww, bye {username}. I'll just be here in the digital void if you need me!"
        else:
            return f"Bye-bye, {username}! See you later!"
