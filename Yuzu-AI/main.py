...
class YuzuApp:
    ...
    def user_join(self, username: str) -> str:
        ...
        if last_seen:
            ...
            return f"Welcome, {username}. I am Yuzu. It is peaceful to have you here. How can I assist your journey today?"
    ...
    def user_leave(self, username: str) -> str:
        ...
        if not self.active_users:
            return f"The room returns to silence as {username} departs. I shall remain here, observing."
        else:
            return f"Goodbye, {username}. May your path be clear."
