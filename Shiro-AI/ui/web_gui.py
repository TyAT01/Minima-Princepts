...
class ShiroGUI:
    """Gradio-based Web GUI for Shiro AI."""
    ...
    def __init__(
        ...
        title: str = "🦊 Shiro: The Sly Kitsune Yaoguai",
        theme: str = "soft"
    ):
    ...
    def build_ui(self):
        # Shiro Kitsune Theme CSS
        self.custom_css = """
        .gradio-container { background-color: #0d0d0d !important; color: #e0e0e0 !important; }
        ...
        with gr.Blocks(title=self.title) as demo:
            ...
            with gr.Row():
                ...
                with gr.Column(scale=1):
                    ...
                    user_name = gr.Textbox(label="Your Name", value="Stranger", placeholder="Enter your name...")
