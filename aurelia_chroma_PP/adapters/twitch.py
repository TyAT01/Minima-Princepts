...
class TwitchChatAdapter(InputAdapter):
    ...
    def __init__(
        ...
        self._username = username or os.getenv("AURELIA_VALE_TWITCH_USERNAME", "").strip()
        self._token = token or os.getenv("AURELIA_VALE_TWITCH_TOKEN", "").strip()
        self._channel = (channel or os.getenv("AURELIA_VALE_TWITCH_CHANNEL", "").strip()).lstrip("#")
