...
class ErrorHandler:
    ...
    def get_ai_fallback_response(self) -> str:
        ...
        fallbacks = [
            "Yah-hoh~ It seems Seed Sr.'s gears are grinding... let me grab my wrench!~",
            "Whoopsie... did I accidentally take apart the system? One sec, putting it back together!~",
            "Bzzt... overheating resolved? Nope, still a bit of smoke coming from the barrel...~",
            "This error doesn't smell like lilies at all... it's more like burnt Nitro-Fuel!~"
        ]
